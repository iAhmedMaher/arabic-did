...
padic_list = []
node_label_pairs = [('MOROCCAN', 'MOR'), ('ANNABA', 'ANN'), ('MODERN-STANDARD-ARABIC', 'MSA'), ('SYRIAN', 'SYR'), ('PALESTINIAN', 'PAL'), ('ALGIERS', 'ALG')]
...
train.to_csv(os.path.join(padic_dir, 'train', 'padic-train.csv'))
evaluate.to_csv(os.path.join(padic_dir, 'eval', 'padic-eval.csv'))
test.to_csv(os.path.join(padic_dir, 'test', 'padic-test.csv'))
