...
default_config = {
    ...
    'tune': {'tuning_method': 'no_search', 'discriminating_metric': 'micro_average_accuracy',
             'discriminating_metric_mode': 'max', 'max_t': 50000000, 'n_samples': 1,
    ...
    'preprocessing': {'normalize': True, 'max_rep': 0, 'tokenizer': 'youtokentome', 'max_seq_len' : 200},
    'model': 'simple_lstm',
