...
default_config = {
    ...
    'device': 'cuda',
    'experiment_name': 'awd-lstm',
    'comet_project_name': 'arabic-did-debug',
    'datasets_dir': r'../datasets',
    'datasets': ['Shami'],
    'training': {'train_batch_size': 64, 'n_train_workers': 8, 'log_every_n_batches': 10,
    ...
    'tune': {'tuning_method': 'hyperopt', 'discriminating_metric': 'micro_average_accuracy',
             'discriminating_metric_mode': 'max', 'max_t': 250000, 'n_samples': 100,
    ...
    'evaluation': {'metrics': ['per_class_precision', 'per_class_recall', 'per_class_f1', 'micro_average_accuracy',
                               ...
                               'in_out', 'cm'],
                   'eval_batch_size': 64, 'n_eval_workers': 8},
