...
default_config = {
    ...
    'datasets': ['Shami'],
    'training': {'train_batch_size': 32, 'n_train_workers': 8, 'log_every_n_batches': 10,
    ...
    'evaluation': {'metrics': ['per_class_precision', 'per_class_recall', 'per_class_f1', 'micro_average_accuracy',
                   ...
                   'eval_batch_size': 32, 'n_eval_workers': 8},
    'penalize_all_steps': True,
    'optimizer': {'name': 'adam', 'lr': 0.00005, 'betas': (0.9, 0.999), 'eps': 1e-08},
    'preprocessing': {'normalize': True, 'max_rep': 0, 'tokenizer': 'transformers_tokenizer', 'max_seq_len' : 150},
    'model': 'bert',
