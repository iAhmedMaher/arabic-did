...
default_config = {
    ...
    'training': {'train_batch_size': 32, 'n_train_workers': 8, 'log_every_n_batches': 50,
                 'training_epochs': 15, 'eval_every_n_batches': 400},
    'tune': {'tuning_method': 'hyperopt', 'discriminating_metric': 'micro_average_accuracy',
             'discriminating_metric_mode': 'max', 'max_t': 100000,
             'resources_per_trial': {'cpu': 2, 'gpu': 1}, 'working_dir': '~/'},
